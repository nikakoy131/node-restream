(function iife() {
    ...
    $.get('liststreams', function liststreams(data) {
    ...
    $('#btn-info').on('click', function infoClickHandler(evt) {
        ...
        $.post('info', { "inputUrl": inputUrl }, function infoPostHandler(data) {
    ...
    $('#btn-add-new').on('click', function btnAddClick(evt) {
        ...
        // var btnStartStop = document.getElementById('btn-start-stop');
        $.post('addstream', { "inputUrl": input, "outputUrl": output, "name": name }, function appStrHeandler(data) {
    ...
    $('#btn-refrash-list').on('click', function btnRefreshClick(evt) {
        $.get('liststreams', function getListstreams(data) {
            renderStreamList(data);
        });
    });
